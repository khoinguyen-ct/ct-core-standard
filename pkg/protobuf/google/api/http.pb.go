...
// and use it for large scale production service.
//
...
// have a proto that is reused in multiple service. Note that any transcoding
...
type HttpRule_Custom struct {
	...
	// for service that provide content to Web (HTML) clients.
